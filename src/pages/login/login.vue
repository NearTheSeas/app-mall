<template>
  ...
  <!--       <form class="loginForm" v-if="loginWay">
        ...
        <div class="login_container" @click="mobileLogin" style="margin-top:1rem;">登录</div>
...
<script>
    ...
    import {userLogin, mobileCode, checkExsis, sendLogin, getcaptchas, accountLogin} from '../../service/getData'
    ...
    export default {
        ...
        methods: {
            ...
            mobileLogin(){
                ...
                //用户名登录
                userLogin(this.userAccount, this.passWord).then(res=>{
                    if(res.data.code == '000'){
                        setShopSign(res.data.data.shopSign, res.data.data.token, res.data.data.shopName, res.data.data.name, '')
                        th.userInfo = res.data.data.name;
                        th.$router.push('/home')
                    }else{
                        this.showAlert = true;
