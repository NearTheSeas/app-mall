            ...
            <section class="scroll_insert">
                ...
                <section class="food_list">
                    ...
                    <ul class="food_list_ul">
                        <li v-for="item in orderData.saleOrderItemList">
                            <p class="food_name ellipsis">{{item.productsName}}</p>
                    ...
                    <div class="pay_ment">实付¥{{orderData.totalAmount.toFixed(2)}}</div>
                </section>
                <section class="order_detail_style">
                    ...
                    <!--<section class="item_style">
                        ...
                        <div class="item_right">
                            <p>{{orderData.deliveryTime | getDate}}</p>
                        </div>
                    </section>-->
                    <section class="item_style">
                        <p class="item_left">送货地址：</p>
                        <div class="item_right">
                            <p>{{orderData.linkName}}</p>
                            <p>{{orderData.phone}}</p>
                ...
                <section class="order_detail_style">
                    ...
                    <section class="item_style">
                        ...
                        <div class="item_right">
                            <p>{{orderData.payTypeDesc}}</p>
                        </div>
                    </section>
                    <section class="item_style">
                        <p class="item_left">下单时间：</p>
                        <div class="item_right">
                            <p>{{orderData.createTime | getDate}}</p>
                        </div>
                    </section>
                </section>
            </section>
...
<script>
    ...
    import {loginData, getOrderDetail} from '../../../service/getData'
